...
plugins {
    ...
    id("java-library")
    alias(aoc2024Libs.plugins.kotlin.jvm) apply false
    alias(aoc2024Libs.plugins.sonarqube.plugin)
}
...
configure<SonarExtension> {
    properties {
        ...
        property("sonar.projectKey", "de.havox_design.aoc:advent_of_code2024")
...
rootProject.allprojects.forEach { currentProject ->
    ...
    currentProject.dependencies {
        testImplementation(aoc2024Libs.hamcrest)
        testImplementation(aoc2024Libs.junit.jupiter)
    }
